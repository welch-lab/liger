...
The developmental versions as well as source version of the previous versions are accessible from GitHub. We are currently contributing to the repository `mvfki/liger` in branch `newObj` for the latest developmental version. To install the latest version from GitHub, please run the following command in R console:
