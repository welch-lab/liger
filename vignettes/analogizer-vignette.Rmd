...
the number of factors in which each marker is found to be significant. This information allows the identification
...
below provide an efficient method of updating. This is much faster than a naive approach of 
