...
RcppExport SEXP _liger_RunModularityClusteringCpp(SEXP SNNSEXP, SEXP modularityFunctionSEXP, SEXP resolutionSEXP, SEXP algorithmSEXP, SEXP nRandomStartsSEXP, SEXP nIterationsSEXP, SEXP randomSeedSEXP, SEXP printOutputSEXP, SEXP edgefilenameSEXP) {
BEGIN_RCPP
...
RcppExport SEXP _liger_ComputeSNN(SEXP nn_rankedSEXP, SEXP pruneSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
...
RcppExport SEXP _liger_WriteEdgeFile(SEXP snnSEXP, SEXP filenameSEXP, SEXP display_progressSEXP) {
BEGIN_RCPP
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::SparseMatrix<double> >::type snn(snnSEXP);
...
RcppExport SEXP _liger_DirectSNNToFile(SEXP nn_rankedSEXP, SEXP pruneSEXP, SEXP display_progressSEXP, SEXP filenameSEXP) {
BEGIN_RCPP
    Rcpp::RObject rcpp_result_gen;
    Rcpp::RNGScope rcpp_rngScope_gen;
    Rcpp::traits::input_parameter< Eigen::MatrixXd >::type nn_ranked(nn_rankedSEXP);
...
static const R_CallMethodDef CallEntries[] = {
    {"_liger_RunModularityClusteringCpp", (DL_FUNC) &_liger_RunModularityClusteringCpp, 9},
    ...
    {"_liger_ComputeSNN", (DL_FUNC) &_liger_ComputeSNN, 2},
    {"_liger_WriteEdgeFile", (DL_FUNC) &_liger_WriteEdgeFile, 3},
    {"_liger_DirectSNNToFile", (DL_FUNC) &_liger_DirectSNNToFile, 4},
    {NULL, NULL, 0}
};
